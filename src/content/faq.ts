/**
 * Homepage FAQ content, captured verbatim from the reference site's accordion.
 * Regenerate with: node .reference-cache/probe-faq.mjs
 */
...
export const HOME_FAQ: FaqItem[] = [
  {
    question: 'What are catalytic converters and why do you buy them?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Yes, we buy every catalytic converter that contains ceramic honeycomb inside. As long as the precious metal-bearing ceramic is present, we will provide you with a competitive quote based on current market rates for Platinum, Palladium, and Rhodium.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'No, every CAT has a different value. The price depends on the specific concentration of precious metals inside. We determine each cat\'s value precisely to ensure you get the fairest price possible.',
  },
  {
    question: 'How do you find the value of each catalytic converter?',
    answer:
      'We find the value by checking the Part Number of each unit against our extensive global catalogue. If the part number is not visible, we use XRF Analysing technology. This high-tech scan identifies the exact precious metal content, helping us find the real market value for you.',
  },
  {
    question: 'Will you buy a catalytic converter if the ceramic inside is broken?',
    answer:
  ...
  {
    question: 'How do I sell my catalytic converter to Catalit?',
    answer:
