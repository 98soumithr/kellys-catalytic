...
export const WHAT_WE_DO_HEADING = {
  title: "What We Do",
  subtitle: "Specialized solutions for modern recycling needs",
};
...
export const WHAT_WE_DO: TitledBlock[] = [
  {
    ...
    body:
      "Specialized collection of catalytic converters and oxygen sensors, utilizing advanced grading for precise valuation.",
  },
  {
    title: "E-Waste Division",
    body:
      "Launched in early 2026, we now handle high-value E-waste, ensuring precious materials are recovered efficiently from electronic scrap.",
  },
  {
    title: "Eco-Friendly Partnerships",
    body:
      "We partner exclusively with reputed recycling companies to ensure every gram of material is processed sustainably, reducing environmental impact.",
  },
];
...
export const WHY_PARTNER: TitledBlock[] = [
  ...
  },
  {
    ...
    body:
      "Strong partnerships with logistics providers ensure smooth operations, no matter your location.",
  },
  {
    title: "Financial Integrity",
    body:
      "We are known for offering the most competitive payouts in the market with spot settlements.",
  },
  {
    title: "Dedicated Support",
    body:
      "Our network members enjoy exclusive perks and 24/7 customer support.",
  },
];
...
export const NETWORK_CARDS: TitledBlock[] = [
  {
    title: "For Field Agents & Freshers",
    body:
      "If you are confident on the field and ready to source materials, we provide the training, logistics, and backing you need to succeed.",
  },
  {
    title: "For Independent Suppliers",
    body:
